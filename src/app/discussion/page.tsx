...
import { getDiscussions, postDiscussion, deleteDiscussion, editDiscussion } from '@/lib/api/discussions';
      ...
      <main className="flex flex-col w-full p-0 snap-y snap-mandatory overflow-y-scroll bg-cream h-dvh">
        ...
        <div className="flex flex-1 p-6 gap-6">
            <div className="flex-1 space-y-4 overflow-y-auto">
                <h1 className="text-5xl font-bold text-gray-900 mb-4">Discussion Forum</h1>
                <DiscussionInput onPost={handlePost} />
                <DiscussionList discussions={discussions} onDelete={handleDelete} onEdit={handleEdit} />
            </div>
