  ...
  return (
    <main className="w-screen h-screen bg-cream flex items-center justify-center overflow-hidden">
        <div className="relative w-[75vw] h-[80vh] bg-bonewhite rounded-4xl flex items-center justify-end overflow-hidden">
            ...
            <div className="absolute w-[35%] h-[95%] flex flex-col items-center justify-start bg-bonewhite z-10 m-4 rounded-3xl">
                <div className="flex justify-start items-start w-full h-20 mt-4 ml-8">
                ...
                <p className="text-black mt-4">Don't have an account? <a href="/signup" className="text-d-brown">Sign up</a></p>
            </div>
        </div>
    </main>
  );
